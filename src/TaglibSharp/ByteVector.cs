...
namespace TagLib
{
	...
	public class ByteVector : IList<byte>, IComparable<ByteVector>
	{
		...
		/// <summary>
		///    Contains values to use in CRC-16 calculation.
		/// </summary>
		static readonly ushort[] crc16_table = new ushort[256] {
		...
		/// <summary>
		///    Contains values to use in CRC-32 calculation.
		/// </summary>
		static readonly uint[] crc32_table = new uint[256] {
		...
		/// <summary>
		///    Gets the CRC-16 checksum of the current instance.
		/// </summary>
		/// <value>
		///    A <see cref="int" /> value containing the CRC-16 checksum
		...
		/// </summary>
		/// <returns>
		///    A <see cref="int" /> value equal to the CRC-32 checksum of
		///    the current instance.
		/// </returns>
		public override int GetHashCode ()
		{
			unchecked { return (int)CRC32; }
		}
